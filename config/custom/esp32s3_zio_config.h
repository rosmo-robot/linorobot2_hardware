...
#ifndef ESP32S3_ZIO_CONFIG_H
#define ESP32S3_ZIO_CONFIG_H
...
// MOTOR PINS
  ...
  #define MOTOR1_IN_A 10 // Pin no 21 is not a PWM pin on Teensy 4.x, you can use pin no 1 instead.
  #define MOTOR1_IN_B 11 // Pin no 20 is not a PWM pin on Teensy 4.x, you can use pin no 0 instead.
...
#define DEVICE_HOSTNAME "esp32s3_zio"
...
#define SDA_PIN 48 // specify I2C pins
#define SCL_PIN 47
#define NODE_NAME "esp32s3_zio"
// #define TOPIC_PREFIX "esp32s3_zio/"
...
#else
#define BATTERY_ADJUST(v) ((v) * (1.1 / 4096 * (470 + 150) / 150))
#endif
// #define USE_INA219
